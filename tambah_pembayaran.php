...
<button class="btn btn-default" onclick="location.href='tampil_pembayaran.php'" style="width: 150px; margin-top: 20px;"> KEMBALI</button>
</form>
</div>
</div>
...
<?php if(isset($_POST['add']))
{
	...
	echo "<script>location='tampil_pembayaran.php?sukses';</script>";
}else{
